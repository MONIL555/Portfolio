...
export default function ContactPanel() {
  return (
    <section id="contact" className="min-h-screen flex flex-col justify-center pt-16 pb-6 px-8 md:px-16 max-w-7xl mx-auto w-full">
      ...
      <a href="/MONIL SOLANKI RESUME.pdf" target="_blank" rel="noopener noreferrer" className="mt-4 glass-panel rounded-3xl p-6 flex flex-col justify-between group cursor-pointer hover:bg-white/50 transition-colors shadow-sm block relative overflow-hidden">
